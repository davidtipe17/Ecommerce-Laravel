            ...
            <form method="post" action="/cliente/guardar">
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 mb-2">
                  ...
                  <input type="password" id="clave" class="form-control" name="clave" placeholder="Nueva Contraseña *" />
                </div>
                <div class="col-12 col-md-6 mb-2">
                  <label class="form-label" for="reclave">Validar Contraseña *</label>
                  <input type="password" id="reclave" class="form-control" name="reclave" placeholder="Validar Contraseña *" />
                </div>
                <div class="col-12">
