        ...
        <div class="col-12 col-md-7">
          ...
          <div class="row">
            <div class="col-6 mb-3">
              ...
              <input type="text" id="nombres" class="form-control" name="nombres" value="{{ Auth::user()->nombres }}"  placeholder="Nombres *" required />
            </div>
            <div class="col-6 mb-3">
              <label for="apellidos" class="form-label">Apellidos *</label>
              <input type="text" id="apellidos" class="form-control" name="apellidos" value="{{ Auth::user()->apellidos }}"  placeholder="Apellidos *" required />
            </div>
          </div>
          <div class="row">
            <div class="col-6 mb-3">
              <label for="email" class="form-label">Email *</label>
              <input type="email" id="email" class="form-control" name="email" value="{{ Auth::user()->email }}"  placeholder="Email *" required />
            </div>
            <div class="col-6 mb-3">
              <label for="telefono" class="form-label">Teléfono *</label>
              <input type="text" id="telefono" class="form-control" name="telefono" value="{{ Auth::user()->telefono }}"  placeholder="Teléfono *" required />
            </div>
          </div>
          <div class="row">
...
function validarEnvio(valor){
  ...
  if(valor=='D'){
    ...
    cajaTexto.value = "Tienda Principal";
  }
}
</script>
@endsection