...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/assets/swiper-6.4.11/swiper-bundle.min.css" />
...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-white">
    <div class="container">
      <!-- Brand -->
      <a class="navbar-brand" href="/">CodiGo Store</a>
      <!-- Toggler -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="offcanvas" aria-controls="offcanvasRight" href="#offcanvasRight">
              <i class="fa fa-shopping-cart"></i> ({{count(session('carrito',[]))}} productos)
            </a>
          </li>
        </ul>
      </div>
          ...
          <div class="row">
            <div class="col-4">
              ...
              <a href="producto.html">
                <img class="img-fluid" src="https://via.placeholder.com/285x180/?text=Producto" alt="producto">
              </a>
            </div>
            <div class="col-8">
              <!-- Title -->
              <p class="font-size-sm font-weight-bold mb-6">
                <a class="text-body" href="producto.html">{{$producto['nombre']}}</a>
                <div class="d-flex justify-content-between">
                  <span class="text-muted">S/ {{$producto['precio']}} x {{$producto['cantidad']}}</span>
                  <a class="font-size-xs text-danger ml-auto" href="/carrito/eliminar/{{$id}}">
